...
<nav class="navbar navbar-dark bg-dark">
            ...
            <br>
            <center><h1>Listado Productos</h1></center>
        <br>
    ...
    $consulta = "SELECT p.id_productos as 'ID', p.nombre_productos as 'Nombre', p.existencias as 'Existencias', pr.nombre AS 'Proveedor', p.precio as 'Precio', p.descripcion as 'Descripción' from productos p inner join proveedores pr on p.id_proveedor = pr.id_proveedores;";
    ...
    echo '<th scope = "col"><h4>Existencias</th></h4>';
    echo '<th scope = "col"><h4>Proveedor</th></h4>';
    echo '<th scope = "col"><h4>Precio</th></h4>';
    ...
    while ($colum = mysqli_fetch_array($result))
    {
        ...
        echo "<td>" . $colum['Existencias'] . "</td>";
        echo "<td>" . $colum['Proveedor'] . "</td>";
        echo "<td>" . $colum['Precio'] . "</td>";
        echo "<td>" . $colum['Descripción'] . "</td>";
        echo "</tr>";
    }
    echo "</table>"; ?>
            </body>
